...
代码阅读顺序:
  整体项木把握: 是asr.py是核心, 整个项目为了asr服务. 里面包括了很多字幕生成和升温识别功能.
  whisperx\types.py
  https://pytorch.org/audio/stable/tutorials/forced_alignment_tutorial.html
  whisperx\audio.py 一些audio和mel计算的函数.
  whisperx\conjunctions.py 一些关联词.
  whisperx\diarize.py 声纹分割聚类、说话人分割聚类、说话人日志
